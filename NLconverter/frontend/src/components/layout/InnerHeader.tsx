  ...
  return (
    <header className="h-16 bg-background/95 backdrop-blur-xl border-b border-slate-800/80 flex items-center justify-between px-6 sticky top-0 z-50 shadow-[0_4px_30px_rgba(0,0,0,0.1)]">
      ...
      <nav className="hidden md:flex items-center gap-8 font-industrial">
        <Link id="nav-link-dashboard" href="/" className="text-[11px] font-bold text-muted hover:text-white uppercase tracking-widest transition-colors">Dashboard</Link>
        ...
        <Link id="nav-link-backtests" href="/backtest" className="text-[11px] font-bold text-muted hover:text-white uppercase tracking-widest transition-colors">Backtests</Link>
      </nav>

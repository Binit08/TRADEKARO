...
TradeKaro NLconverter includes a comprehensive documentation suite located in the `/documentation` folder:

### Phase 1: Foundation
- [Project Requirements Document (PRD)](./documentation/PRD.md)
- [System Architecture](./documentation/ARCHITECTURE.md)
- [Contributing Guide](./documentation/CONTRIBUTING.md)

### Phase 2: Technical Reference
- [API Reference](./documentation/API_REFERENCE.md)
- [Data Model & Schema](./documentation/DATA_MODEL.md)
...
- [Architecture Decision Records (ADRs)](./documentation/adr/README.md)

...
from app.market_data.interfaces import LiveFeedAdapter

logger = logging.getLogger(__name__)

class BinanceLiveFeedAdapter(LiveFeedAdapter):
    """Live WebSocket feed using Binance Public API.
    
    Subscribes to Binance @kline stream and yields events
    for crypto symbols (e.g. BTCUSDT) 24/7.
    """
    ...
    def _on_message(self, ws, message):
        ...
        if "data" in data and "k" in data["data"]:
            ...
            # If the kline is closed (completed), emit a CandleEvent
            is_closed = kline["x"]
